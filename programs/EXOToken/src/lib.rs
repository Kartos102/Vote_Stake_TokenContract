...
use staking_reward::cpi as stakingcpl;

use staking_reward::cpi::accounts::{ UpdatePauseRoleOrAddressOrInfo };

pub mod state;

declare_id!("C6q5L8URVy9ie4cnvjoUGW9uh1caEVDes8Ho5w9N343W");
...
pub mod exo_token {
    ...
    pub fn proxy_transfer (_ctx: Context<ProxyTransfer>, _amount: String) -> Result<()> {
        ...
        let total_stake_amount: u64 =  stakingcpl::get_total_stake_amount()
